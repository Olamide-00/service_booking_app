    ...
    <SafeAreaView style={styles.root}>
      ...
      >
        ...
        <RegularText size="small">
          Remit Technologies Ltd. was founded by Olamide Oladele and co-founded
          by Igbalaye Gabriel. Our company is committed to providing seamless
          digital payment solutions while ensuring user privacy and security. We
          are dedicated to maintaining a transparent and user-friendly platform
        ...
        <RegularText size="small">
          We do not collect, store, or share personal user data. Our platform is
          designed to respect user privacy, ensuring that your information
        ...
        <RegularText size="small">
          ...
          privacy policies of any external services they choose to engage with.
        </RegularText>
        <Spacer size={15} direction="vertical" />
        ...
        <RegularText size="small">
          ...
          to protect your data and transactions. Our team continuously monitors
          and updates security features to mitigate any potential risks.
        </RegularText>
        <Spacer size={15} direction="vertical" />
        ...
        <RegularText size="small">
          ...
          support team at support.Remit@gmail.com We are here to assist you and
          ensure a smooth experience while using our services.
        </RegularText>
      </ScrollView>
